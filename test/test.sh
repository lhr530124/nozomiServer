...
ab -n 1000 -c 100 http://localhost:9003/getClanMembers?cid=3 
ab -n 1000 -c 100 http://localhost:9003/getRandomClans?score=100
ab -n 1000 -c 100 http://localhost:9003/searchClans?word=wangguo
ab -n 1000 -c 100 -p find.txt  http://localhost:9003/findLeagueEnemy?word=wangguo
...
ab -n 1000 -c 100  http://localhost:9003/getLeagueMemberData?uid=2\&cid=3
ab -n 1000 -c 100  http://localhost:9003/clearBattleState?eid=3
